...
//             reply.message = "All StudentInfo Gotten"
//             reply.success = true
//             reply.Grade = "A+"
...
//             let details: any = url?.split("/")[1];
//             let datailvalue = parseInt(details);

//             let findObject = StudentInfo.some((el: any) => {
//                 return el.RegNum === datailvalue
//             })
...
//                 StudentInfo = StudentInfo.map((User:any) => {
//                     if (User?.RegNum === datailvalue){
//                         return {
//                             RegNum: User?.RegNum,
//                             updateusername, Age: updateAge,
//                         }
//                     }
//                     return User
//                 });
...
//                 StudentInfo = StudentInfo.map((User: any) => {
//                     if(User?.RegNum === detailvalue){
//                         return User.RegNum !== detailvalue
//                     }
//                     return User;
//                 })
